...
(function(){
  const PAGES = [
    {key:'land',     href:'/land-management', label:'Land Management',     short:'Land',     blurb:'Permits, plan reviews, inspections — without the printer.'},
    {key:'hr',       href:'/human-resources', label:'Human Resources',     short:'HR',       blurb:'Onboarding, employment contracts, the people-side of government.'},
    {key:'budget',   href:'/budget-management', label:'Budget Management', short:'Budget',   blurb:'Follow the money — funds, vendors, encumbrances, payments.'},
    {key:'licensing',href:'/licensing', label:'Licensing',                short:'Licensing',blurb:'Applications and renewals, signed and issued online.'},
    {key:'foia',     href:'/record-requests', label:'Record Requests',     short:'FOIA',     blurb:'Public-records requests routed, redacted, fulfilled.'},
    {key:'311',      href:'/311', label:'311 / Citizen Services', short:'311', blurb:'From "there\u2019s a pothole" to a closed work order.'},
    {key:'reports',  href:'/reports', label:'Reports & Dashboards', short:'Reports', blurb:'Live numbers from the same database staff are working in.'},
  ];
  ...
  function renderNav(active){
    ...
    <header class="cm-nav">
      <div class="cm-nav-row">
        <a href="/" class="cm-nav-logo" aria-label="Clarity Value home">
        ...
        <nav class="cm-nav-links">
          <a class="cm-nav-link" href="/#product">Product</a>
          <div class="cm-nav-dropdown">
            ...
            <div class="cm-nav-dd-panel" role="menu">
              <a class="cm-nav-dd-item" href="/record-requests" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/land-management" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/licensing" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/311" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/reports" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/budget-management" role="menuitem">
              ...
              <a class="cm-nav-dd-item" href="/human-resources" role="menuitem">
              ...
              <div class="cm-nav-dd-foot">
                <a class="cm-nav-dd-all" href="/#modules">See all solutions
    ...
    <section class="cm-xlink">
      <div class="cm-wrap">
        <div class="cm-xlink-head">
          ...
          <a class="cm-btn cm-btn--ghost" href="/#modules" style="height:36px;font-size:13px">All modules
            <svg viewBox="0 0 12 12" fill="none"><path d="M2 6h7M6 3l3 3-3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
          </a>
        </div>
        ...
        <div class="cm-cta-row">
          ...
          <div class="cm-cta-side">
            ...
            <div class="cm-cta-actions">
              <a class="cm-btn cm-btn--primary" href="/contacts">Request a pilot
                <svg viewBox="0 0 12 12" fill="none"><path d="M2 6h7M6 3l3 3-3 3" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>
              </a>
              <a class="cm-btn cm-btn--ghost-dark" href="/#product">See the product</a>
            </div>
          </div>
        </div>
      </div>
